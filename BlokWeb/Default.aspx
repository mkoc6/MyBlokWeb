<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BlokWeb.WebForm1" %>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">SUN is COMIG</span>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <div class="my-auto">
                        <h1 class="mb-0">
                            <asp:Label runat="server" Text='<%#Eval("AD") %>'></asp:Label>
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("BASLIK") %>'></asp:Label></h3>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label10" runat="server" Text='<%#Eval("BASLIK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label11" runat="server" Text='<%#Eval("ALTBASLIK") %>'></asp:Label>
                                </div>
                                <div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <div class="subheading mb-3">Programlama dıllerı</div>
                ...
                <div class="subheading mb-3">ıs akısı</div>
            ...
            <asp:Repeater ID="Repeater4" runat="server">
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <p>
                            <asp:Label ID="Label15" runat="server" Text='<%# Eval("HOBI") %>'></asp:Label>
                    ...
                    <div class="my-auto">
                        ...
                        <ul class="fa-ul mb-0">
                            <li>
                                ...
                                <asp:Label ID="Label16" runat="server" Text='<%#Eval("PROJELER") %>'></asp:Label></li>
